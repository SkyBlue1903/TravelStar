...
//        KOMPONEN YANG ADA DI ACTIVITY TICKET DETAIL
...
//                OVERWRITE DATA YANG ADA DI ACTIVITY ITU
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(getApplicationContext(), "Database eror, silakan coba lagi nanti :(", Toast.LENGTH_SHORT).show();
            }
        });

        Toast.makeText(getApplicationContext(), "Anda memilih " + jenis_tiket_baru, Toast.LENGTH_SHORT).show();
